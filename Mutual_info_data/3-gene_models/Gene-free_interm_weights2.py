...
def dyn(var):
	...
	ddyn[0] = var[0]*(1.-r) -var[1]
	ddyn[1] = var[1]*(1.-r) +var[0]
...
def df(var, par):
	...
	return par**2*dyn(var) +(1.-par)**2*stat(var) -par*(1.-par)*var
...
file = open("MI_data_gene-free_interm_weights2_"+str(noise_index+1)+".txt", "w")
